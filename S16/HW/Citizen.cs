...
class Teacher: Citizen
{
    ...
    public Teacher(string fname, string lname, int id, bool isMale, int salary, int rating, int EmployeeId)
        :base(fname, lname, id, isMale, 0)
    {
        this.Salary = salary;
        this.Rating = rating;
    ...
    public override string ToString()
    {
        return $"{base.ToString()}, {this.EmployeeId}";
    }
}
